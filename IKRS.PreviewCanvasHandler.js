...
IKRS.PreviewCanvasHandler = function( bezierCanvasHandler, preview_canvas_width, preview_canvas_height) {
  ...
  this.preview_camera = new THREE.PerspectiveCamera( 75, preview_canvas_width/preview_canvas_height,  0.1, 8000);
  ...
  this.preview_pointLight = new THREE.PointLight(0xFFFFFF);
  ...
  var bg = new THREE.Mesh(new THREE.PlaneGeometry( 2, 2, 0 ), new THREE.MeshBasicMaterial( { map: backgroundTexture } ));
  ...
  this.preview_renderer.setSize(preview_canvas_width, preview_canvas_height );
...
IKRS.PreviewCanvasHandler.prototype._setCameraPositionFromLocalSettings = function() {
  ...
  var newCameraOffset_X = new THREE.Vector3(
    Math.cos( this.preview_camera.ikrsSettings.rotation.x ),
